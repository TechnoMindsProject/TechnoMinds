...
<div className="w-full max-w-screen-lg p-6 bg-white rounded-lg shadow-md">
  ...
  <div className="space-y-4">
    ...
    <div className="flex justify-between items-center">
      <p className="text-lg text-[#363636]">Name Surname</p>
      <Link href="/edit_name" className="flex items-center text-[#1aae98] hover:underline">
        <FaEdit size={16} color="#1aae98" />
    ...
    {/* Email */}
    <div className="flex justify-between items-center">
      <p className="text-lg text-[#363636]">email@example.com</p>
      <Link href="/edit_email" className="flex items-center text-[#1aae98] hover:underline">
        <FaEdit size={16} color="#1aae98" />
        <span className="ml-2">Edit</span>
      </Link>
    </div>
    ...
    {/* Phone Number */}
    <div className="flex justify-between items-center">
      <p className="text-lg text-[#363636]">+380 44 300 30 30</p>
      <Link href="/edit_phone" className="flex items-center text-[#1aae98] hover:underline">
        <FaEdit size={16} color="#1aae98" />
        <span className="ml-2">Edit</span>
      </Link>
    </div>
