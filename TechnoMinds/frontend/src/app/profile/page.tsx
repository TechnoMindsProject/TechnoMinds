  ...
  <p className="text-[22px] font-bold text-[#363636] mb-2 flex items-center cursor-pointer hover:text-[#1aae98]">
    ...
    <ul>
      <li className="text-xl font-bold text-[#363636] mb-2 flex items-center">
        ...
        <Link href="/profile_view_resumes" className="hover:text-[#1aae98]">View resumes</Link>
      </li>
      <li className="text-xl font-bold text-[#363636] mb-2 flex items-center">
      ...
      <li className="text-xl font-bold text-[#363636] flex items-center">
        ...
        <div className="w-full max-w-screen-lg p-6 bg-white rounded-lg shadow-md">
          {/* My Resumes Section */}
          <div className="mb-8">
            <h3 className="text-[26px] font-semibold text-[#1aae98] mb-4">Create a resume</h3>
            <p className="text-lg text-[#363636] mb-4">
              In just 3-5 minutes, employers will be able to see your resume and offer you a job.
            </p>
            <div className="flex space-x-4">
              <button className="bg-[#1aae98] text-white py-2 px-6 rounded-lg hover:bg-[#187371]">
                Create
              </button>
              <button className="border-2 border-[#1aae98] text-[#1aae98] py-2 px-6 rounded-lg hover:bg-[#dcdbdb]">
                Upload the file
              </button>
            </div>
          </div>
...
<div>
  <h3 className="text-[26px] font-semibold text-[#1aae98] mb-4">Personal data</h3>
  <div className="text-lg text-[#363636] mb-4">
    <p className="flex items-center">
      <FaUser className="mr-2" /> {/* Іконка для імені */}
      <strong>Name: <span className="ml-1"></span></strong> Name Surname
    </p>
    <p className="flex items-center">
      <FaEnvelope className="mr-2" /> {/* Іконка для емейлу */}
      <strong>Email: <span className="ml-1"></span></strong> email@example.com
    </p>
  </div>
  <div className="flex items-center">
  <Link href="/edit_personal_data" className="flex items-center">
  <button className="text-[#1aae98] hover:underline mr-2">
    Edit
  </button>
  <FaEdit size={16} color="#1aae98" /> {/* Іконка для редагування */}
</Link>
  </div>
</div>
</div>
